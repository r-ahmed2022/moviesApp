...
A movie app enabling movies search, adding favorite movies to watchlist
...
- [Live Demo Link](https://r-ahmed2022.github.io/moviesApp/)
...
1. Clone this repository to your desired location by typing this command on the terminal:
 git clone [](https://github.com/r-ahmed2022/moviesApp.git)
2. Open the folder "moviesApp" and run `npm install` to install all necesary scripts,
